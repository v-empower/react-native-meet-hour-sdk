...
public class RNMeetHourView extends BaseReactView<MeetHourViewListener>
        implements RNOngoingConferenceTracker.OngoingConferenceListener {

    /**
     * The {@code Method}s of {@code MeetHourViewListener} by event name i.e.
     * redux action types.
     */
    private static final Map<String, Method> LISTENER_METHODS
            = ListenerUtils.mapListenerMethods(MeetHourViewListener.class);
    ...
    /**
     * Joins the conference specified by the given {@link RNMeetHourConferenceOptions}. If there is
