...
/**
 * This class represents the options when joining a Meet Hour conference. The user can create an
 * instance by using {@link RNMeetHourConferenceOptions.Builder} and setting the desired options
 * there.
 *
 * The resulting {@link RNMeetHourConferenceOptions} object is immutable and represents how the
...
public class RNMeetHourConferenceOptions implements Parcelable {
    ...
    /**
     * Color scheme override, see: https://github.com/v-empower/meet-hour/blob/dbedee5e22e5dcf9c92db96ef5bb3c9982fc526d/react/features/base/color-scheme/defaultScheme.js
     */
    private Bundle colorScheme;

    /**
     * Feature flags. See: https://github.com/v-empower/meet-hour/blob/master/react/features/base/flags/constants.js
     */
    ...
    /**
     * Class used to build the immutable {@link RNMeetHourConferenceOptions} object.
     */
    public static class Builder {
         ...
         * https://github.com/v-empower/meet-hour/blob/master/react/features/base/color-scheme/defaultScheme.js
         * for the structure.
        ...
        /**
         * Builds the immutable {@link RNMeetHourConferenceOptions} object with the configuration
         * that this {@link Builder} instance specified.
         * @return - The built {@link RNMeetHourConferenceOptions} object.
         */
