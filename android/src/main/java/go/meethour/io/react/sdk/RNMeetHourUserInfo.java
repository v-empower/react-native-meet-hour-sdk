...
/**
 * This class represents user information to be passed to {@link RNMeetHourConferenceOptions} for
 * identifying a user.
 */
public class RNMeetHourUserInfo {
    /**
     * User's display name.
     */
    ...
    public RNMeetHourUserInfo() {}

    public RNMeetHourUserInfo(Bundle b) {
        super();
